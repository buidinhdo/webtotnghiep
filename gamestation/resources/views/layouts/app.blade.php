                ...
                document.addEventListener('alpine:init', () => {
                    Alpine.data('chatbotComponent', () => ({
                                ...
                                this.recognition.onend = () => {
                                 ...
                                 this.recognition.onresult = (event) => {
                                     ...
                                     if (transcript) {
                                         ...
                                         // Remove commas and periods generated by speech recognition pauses
                        ...
                        formatMessage(text) {
                            ...
                            formatted = formatted.replace(/!\[(.*?)\]\((.*?\.(?:jpeg|jpg|png|webp|gif|svg))\)/gi, '<img src="$2" alt="$1" class="max-w-full rounded-lg mt-2 shadow-md border border-slate-700 max-h-48 object-cover">');
