            ...
            <form method="POST" action="{{ route('password.direct') }}" class="mt-8 space-y-4">
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        <x-text-input id="password" class="w-full gs-auth-input pr-10" type="password" name="password" required autocomplete="new-password" placeholder="Mật khẩu mới" />
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        <x-text-input id="password_confirmation" class="w-full gs-auth-input pr-10" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Xác nhận mật khẩu" />
